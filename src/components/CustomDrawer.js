...
import { Divider, Drawer, useTheme, Text, Switch } from "react-native-paper";
        ...
        <View style={styles.header}>
          <View style={styles.ribbonContainer}>
            <View
              style={[
                styles.ribbon,
                {
                  backgroundColor: appVersion === "pro" ? "#ff0000" : "#4caf50",
                },
              ]}
            >
              <Text style={styles.ribbonText}>{appVersion.toUpperCase()}</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text
              ...
              style={{ color: "white", marginLeft: 20, fontWeight: "bold" }}
            >
              RADAR EARTH
            </Text>
          </View>
